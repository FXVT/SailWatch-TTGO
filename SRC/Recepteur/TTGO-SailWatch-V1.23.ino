...
// #include "SL31s.h"   //image du bateau de coté pour ecran profondeur
...
void photoSB () {
  ttgo->tft->fillScreen(TFT_BLACK);                 // efface l'écran
  ttgo->tft->setSwapBytes(true);
  ttgo->tft->pushImage(15, 0, 209, 240, SB240);     //affiche la photo de SylviepushImage(x,y,209,240,image)
